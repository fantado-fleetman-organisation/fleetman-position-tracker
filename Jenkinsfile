pipeline {
   agent any
   parameters {
    string(name: 'SERVICE_NAME', defaultValue: 'fleetman-position-tracker', description: 'Microservice name')
    string(name: 'ECR_REPO_NAME', defaultValue: 'fleetman-position-tracker', description: 'ECR repo name')
